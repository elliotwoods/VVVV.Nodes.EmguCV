...
namespace VVVV.Nodes.EmguCV
{
	public class TemplateInstance : IFilterInstance
	{
		...
		protected override void InitialiseOutput()
		{
			...
			//Initialising = setting the attributes (i.e. not allocating the memory yet)
		...
		unsafe private void PixelWiseAdd()
		{
	...
	public class GeneratorEmguCVNoiseNode : IFilterNode<TemplateInstance>
	{
		[Input("Add")]
