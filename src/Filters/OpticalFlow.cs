...
{
	public class OpticalFlowInstance : IFilterInstance
	{
		private Size FSize;
		...
		public override void Process()
		{
			...
			COLOR_CONVERSION route = CVImageUtils.ConvertRoute(FInput.ImageAttributes.ColourFormat, TColourFormat.L8);
	...
	#region PluginInfo
	[PluginInfo(Name = "OpticalFlow", Category = "EmguCV", Help = "Perform LK optical flow on image", Author = "elliotwoods", Credits = "", Tags = "")]
	#endregion PluginInfo
	public class OpticalFlowNode : IFilterNode<OpticalFlowInstance>
	{
