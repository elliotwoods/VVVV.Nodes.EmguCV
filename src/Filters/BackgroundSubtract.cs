...
namespace VVVV.Nodes.EmguCV
{
	...
	#region PluginInfo
	[PluginInfo(Name = "BackgroundSubtract", Category = "EmguCV", Version = "", Help = "Output difference between current frame and captured background", Author = "elliotwoods", Credits = "", Tags = "")]
